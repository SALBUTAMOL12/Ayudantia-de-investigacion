...
if True:
    ...
    v = villages_batch.loc[villages_batch.batch.eq('87')].reset_index().loc[2]
    ...
    ms = x.multispectral(112)  # ! antes era 112
    ...
    ms.to_tif('../local/examples/msp_rgb.tif', [3, 2, 1])
    ...
    pan = x.panchromatic(224)  # ! antes era 224
    ...
    com = x.combine(224)  # ! antes era 224
    ...
    com.to_tif('../local/examples/com_pansharpen_rgb.tif', 'pansharpen', [3, 2, 1])
